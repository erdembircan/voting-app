...
},{"process/browser.js":10}],12:[function(require,module,exports){
'use strict';
...
var _toast = require('../../../server/templates/partials/toast.hbs');
...
var Toasts = function () {
  function Toasts(container) {
    ...
    this._toastContainer = (0, _parseHtml2.default)("<div class='toastContainer'></div>").firstChild;
  ...
  _createClass(Toasts, [{
    ...
    value: function showToast(message) {
      var toast = new Toast(message, this._toastContainer);
...
function Toast(message, container) {
  ...
  this._container = (0, _parseHtml2.default)((0, _toast2.default)({ message: message })).firstChild;

  this._container.addEventListener('animationend', function (e) {
    if (e.animationName === 'disDown') {
      container.removeChild(_this._container);
    }
  });
}
...
},{"../../../server/templates/partials/toast.hbs":16,"../util/parseHtml":15,"timers":11}],13:[function(require,module,exports){
'use strict';
...
var indexController = new _indexController2.default('#base');

var messageHolder = document.querySelector('[data-message]');
var errorHolder = document.querySelector('[data-error]');

var message = messageHolder.dataset.message;
var error = errorHolder.dataset.error;


if (message !== '') indexController.showToast(message);
if (error !== '') indexController.showToast(error);

},{"./indexController":14}],14:[function(require,module,exports){
'use strict';
...
var _Toasts = require('./components/Toasts');
...
var IndexController = function () {
  function IndexController(containerId) {
    _classCallCheck(this, IndexController);

    this._container = document.querySelector(containerId);
    this._toasts = new _Toasts2.default(this._container);
  }
...
},{"./components/Toasts":12}],15:[function(require,module,exports){
"use strict";
