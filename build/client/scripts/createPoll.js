...
var _inputSegment = require('../../../src/server/templates/partials/inputSegment.hbs');

var _inputSegment2 = _interopRequireDefault(_inputSegment);
...
var addB = document.querySelector('#addItem');
var removeB = document.querySelector('#removeItem');
...
function itemHandler(type) {
  ...
  if (type === 'remove') {
    ...
    var postNumber = itemLength + 1;
    var inputElement = (0, _parseHtml2.default)((0, _inputSegment2.default)({ itemNumber: postNumber }), itemContainer);

    itemContainer.appendChild(inputElement);
  }
}

},{"../../../src/server/templates/partials/inputSegment.hbs":12,"./util/parseHtml":11}],11:[function(require,module,exports){
"use strict";
